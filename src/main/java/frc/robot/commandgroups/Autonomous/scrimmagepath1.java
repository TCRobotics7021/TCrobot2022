...
public class scrimmagepath1 extends SequentialCommandGroup {
  ...
  public scrimmagepath1() {
    ...
    Trajectory scrimmagepath1part1 = RobotContainer.drive_subsystem.loadTrajectoryFromFile("scrimmagepath1part1");
    Trajectory scrimmagepath1part2 = RobotContainer.drive_subsystem.loadTrajectoryFromFile("scrimmagepath1part2");
    Trajectory scrimmagepath1part3 = RobotContainer.drive_subsystem.loadTrajectoryFromFile("scrimmagepath1part3");
